    ...
    <div id="box_wrapper">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12 text-sm-center">
                            ...
                            <nav class="mainmenu_wrapper">
                                <ul class="mainmenu nav sf-menu text-center">
                                    ...
                                    <!-- Shop -->
                                    <li>
                                        <a href="shop-type-1.html">Products</a>
                                    </li>
                                    ...
                                    <!-- Blog -->
                                    <li>
                                        <a href="blog-right.html" data-target="#blog">Blog</a>
                                    </li>
                                    ...
                                    <!-- Contact -->
                                    <li>
                                        <a href="contact-01.html" data-target="#contact">Contacts</a>
                                    </li>
                                </ul>
                            </nav>
                            <!-- eof main nav -->
        ...
        <div class="ls section_padding_bottom_20">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h3 class="title_t-1 title_t-1--position2 text-center">Our Grown Up Plants</h3>
                        <p class="sub-title_t-5 title_t-1--position3 text-center">We grow only the Best fruits and vegetables to every family!</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="ls section_padding_bottom_20">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="home-shop-feed">
                            <ul id="products" class="products list-unstyled grid-view shop-feed-t2">
                                <li class="shop-item product type-product">
                                    <div class="side-item">
                                        <figure class="item-media shop-item__img">
                                            <a href="shop-single-item.html">
                                                <img src="images/shop/shop_img-11.jpg" alt="">
                                            </a>
                                            <div class="shop-item__lk-wrapp">
                                                <a href="index.html#" class="shop-item__lk">Info</a>
                                            </div>
                                        </figure>
                                        <div class="shop-item__content">
                                            <h3 class="shop-item__title">
                                                <a href="shop-single-item.html">Strawberry</a>
                                            </h3>
                                ...
                                <li class="shop-item product type-product">
                                    <div class="side-item">
                                        ...
                                        <div class="shop-item__content">
                                            <h3 class="shop-item__title">
                                                <a href="shop-single-item.html">Healthy Tomatoes</a>
                                            </h3>
                                            <div class="shop-item__meta-list">
                                                <div class="star-rating" title="Rated 4.00 out of 5">
                                                    <span style="width:80%">
                                ...
                                <li class="shop-item product type-product">
                                    <div class="side-item">
                                        ...
                                        <div class="shop-item__content">
                                            <h3 class="shop-item__title">
                                                <a href="shop-single-item.html">Sweet Paprika</a>
                                            </h3>
                                            <div class="shop-item__meta-list">
                                                <div class="star-rating" title="Rated 4.00 out of 5">
                                                    <span style="width:80%">
                                ...
                                <li class="shop-item product type-product">
                                    <div class="side-item">
                                        <figure class="item-media shop-item__img">
                                            <a href="shop-single-item.html">
                                                <img src="images/shop/shop_img-10.jpg" alt="">
                                            </a>
                                            <div class="shop-item__lk-wrapp">
                                                <a href="index.html#" class="shop-item__lk">Info</a>
                                            </div>
                                        ...
                                        <div class="shop-item__content">
                                            <h3 class="shop-item__title">
                                                <a href="shop-single-item.html">Vitamin Kiwi</a>
                                            </h3>
                                            <div class="shop-item__meta-list">
                                                <div class="star-rating" title="Rated 4.00 out of 5">
                                                    <span style="width:80%">
                                ...
                                <li class="shop-item product type-product">
                                    <div class="side-item">
                                        <figure class="item-media shop-item__img">
                                            <a href="shop-single-item.html">
                                                <img src="images/shop/shop_img-03.jpg" alt="">
                                            </a>
                                            <div class="shop-item__lk-wrapp">
                                                <a href="index.html#" class="shop-item__lk">Info</a>
                                            </div>
                                        ...
                                        <div class="shop-item__content">
                                            <h3 class="shop-item__title">
                                                <a href="shop-single-item.html">Tasty Potatoes</a>
                                            </h3>
                                            <div class="shop-item__meta-list">
                                                <div class="star-rating" title="Rated 4.00 out of 5">
                                                    <span style="width:80%">
                                ...
                                <li class="shop-item product type-product">
                                    <div class="side-item">
                                        <figure class="item-media shop-item__img">
                                            <a href="shop-single-item.html">
                                                <img src="images/shop/shop_img-12.jpg" alt="">
                                            </a>
                                            <div class="shop-item__lk-wrapp">
                                                <a href="index.html#" class="shop-item__lk">Info</a>
                                            </div>
                                        ...
                                        <div class="shop-item__content">
                                            <h3 class="shop-item__title">
                                                <a href="shop-single-item.html">Yammy Peaches</a>
                                            </h3>
                                            <div class="shop-item__meta-list">
                                                <div class="star-rating" title="Rated 4.00 out of 5">
                                                    <span style="width:80%">
        ...
        <div class="ls section_padding_top_20 section_padding_bottom_100">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class="testimonials">
                            <div id="carousel-media" class="carousel slide testimonials-carousel" data-ride="carousel">
                                <p class="testimonials__sub-title">What our clients says about us</p>
                                    ...
                                    <div class="item active">
                                        <div class="media">
                                            <div class="media-body">
                                                <h4 class="testimonials__title-user">
                                                    <a href="index.html#">Greg Doe</a>
                                                </h4>
                                                <p class="testimonials__sub-title-user">Our happy customer</p>
                                                <p class="testimonials__text">Lid est laborum dolo rumes fugats untras. Etha rums ser quidem rerum facilis dolores nemis onis fugats vitaes nemo minima rerums unsers sadips amets.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="media">
                                            <div class="media-body">
                                                <h4 class="testimonials__title-user">
                                                    <a href="index.html#">John Walker</a>
                                                </h4>
                                                <p class="testimonials__sub-title-user">Our happy customer</p>
                                                <p class="testimonials__text">Lid est laborum dolo rumes fugats untras. Etha rums ser quidem rerum facilis dolores nemis onis fugats vitaes nemo minima rerums unsers sadips amets.</p>
                                            </div>
